...
public class NodeNotification : Form
{
    ...
    public NodeNotification(Image image, string title, string text, Color borderColor)
    {
        //Initialize our form
        InitializeComponent();
        //Set our image
    ...
    /// <summary>
    /// Creates a new notification with the specified icon, title, text, border color for the specified amount of time in seconds.
    /// </summary>
    /// <param name="image">The icon that will be placed at the left of the form</param>
    /// <param name="title">The title that will be shown at the top left of the form</param>
    /// <param name="text">The text that will be placed ton the center right of the form</param>
    ...
    public NodeNotification(Image image, string title, string text, Color borderColor, int seconds) : this(image, title, text, borderColor)
    {
        Seconds = seconds;
    ...
    /// <summary>
    /// Creates a new notification with the specified icon, title, text, border color for the specified amount of time in seconds with a sound to be played on display.
    /// </summary>
    /// <param name="image">The icon that will be placed at the left of the form</param>
    /// <param name="title">The title that will be shown at the top left of the form</param>
    /// <param name="text">The text that will be placed ton the center right of the form</param>
    ...
    public NodeNotification(Image image, string title, string text, Color borderColor, int seconds, string soundPath) : this(image, title, text, borderColor, seconds)
    {
        SoundPath = soundPath;
    }
    /// <summary>
    ...
    /// <param name="borderColor">The color which form the border will have</param>
    /// <param name="soundPath">The path to the sound file (SoundPlayer class)</param>
    public NodeNotification(Image image, string title, string text, Color borderColor, string soundPath) : this(image, title, text, borderColor)
    {
        SoundPath = soundPath;
    }
    /// <summary>
    ...
    public NodeNotification(Image image, string title, string text, Color borderColor, Stream soundStream) : this(image, title, text, borderColor)
    {
    ...
    /// <param name="seconds">The time in seconds for the form to be left displayed</param>
    /// <param name="soundStream">The stream for which the SoundPlayer will read</param>
    public NodeNotification(Image image, string title, string text, Color borderColor, int seconds, Stream soundStream) : this(image, title, text, borderColor, seconds)
    {
        SoundStream = soundStream;
    }
    ...
    private void InitializeComponent()
    {
        ...
        this.Name = "NodeNotification";
        this.Text = "NodeNotification";
